import{r as n}from"./index-B3ie1F2B.js";import{s as j}from"./useUsuario-DqHBhlC3.js";function B(c,f){const[s,h]=n.useState([]),[g,p]=n.useState([]),[L,b]=n.useState(!1),[q,u]=n.useState(null),[x,m]=n.useState([]),[A,S]=n.useState([]),[N,_]=n.useState([]);n.useEffect(()=>{(async()=>{if(!(!c||!c.id)){b(!0),u(null);try{const{data:a,error:i}=await j.from("catalogo_usuario").select(`
              id,
              contenido_id,
              estado,
              favorito,
